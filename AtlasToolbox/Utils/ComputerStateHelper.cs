...
namespace AtlasToolbox.Utils
{
    ...
    public static class ComputerStateHelper
    {
        ...
        public async static void LogOffComputer()
        {
            ...
            //App.contentDialog.Style = Application.Current.Resources["DefaultContentDialogStyle"] as Style;
            //App.contentDialog.Title = "Do you really wish to delete this profile?";
            //App.contentDialog.PrimaryButtonText = "Yes";
            //App.contentDialog.CloseButtonText = "Cancel";
            //App.contentDialog.DefaultButton = ContentDialogButton.Primary;
