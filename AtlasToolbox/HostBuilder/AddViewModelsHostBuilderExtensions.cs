...
namespace AtlasToolbox.HostBuilder
{
    public static class AddViewModelsHostBuilderExtensions
    {
        ...
        private static IHostBuilder AddConfigurationItemViewModels(this IHostBuilder host)
        {
            ...
            {
                ["Animations"] = new ("Animations", "Animations", ConfigurationType.Interface, RiskRating.LowRisk, FluentIcons.Common.Icon.FastAcceleration),
                ["ExtractContextMenu"] = new("\"Extract\" option in the context menu", "ExtractContextMenu", ConfigurationType.ContextMenuSubMenu, RiskRating.LowRisk, FluentIcons.Common.Icon.DocumentTextExtract),
                ["RunWithPriority"] = new("Run With Priority in context menu", "RunWithPriority", ConfigurationType.ContextMenuSubMenu, RiskRating.MediumRisk, FluentIcons.Common.Icon.AppsSettings),
                ["Bluetooth"] = new("Bluetooth", "Bluetooth", ConfigurationType.ServicesSubMenu, RiskRating.HighRisk, FluentIcons.Common.Icon.Bluetooth),
                ["LanmanWorkstation"] = new("Lanman Workstation (SMB)", "LanmanWorkstation", ConfigurationType.ServicesSubMenu, RiskRating.HighRisk, FluentIcons.Common.Icon.PlugConnected),
                ["NetworkDiscovery"] = new("Network Discovery", "NetworkDiscovery", ConfigurationType.ServicesSubMenu, RiskRating.HighRisk, FluentIcons.Common.Icon.NetworkCheck),
                ["Printing"] = new("Printing", "Printing", ConfigurationType.ServicesSubMenu, RiskRating.LowRisk, FluentIcons.Common.Icon.Print),
                ["NvidiaDispayContainer"] = new("NVIDIA Display Container", "NvidiaDispayContainer", ConfigurationType.NvidiaDisplayContainerSubMenu, RiskRating.HighRisk, FluentIcons.Common.Icon.XboxController),
                ["AddNvidiaDisplayContainerContextMenu"] = new("NVIDIA Display Container in context menu", "AddNvidiaDisplayContainerContextMenu", ConfigurationType.NvidiaDisplayContainerSubMenu, RiskRating.HighRisk, FluentIcons.Common.Icon.XboxController),
                ["CpuIdleContextMenu"] = new("CPU Idle toggle in context menu", "CpuIdleContextMenu", ConfigurationType.ContextMenuSubMenu, RiskRating.MediumRisk, FluentIcons.Common.Icon.DesktopPulse),
                ["LockScreen"] = new("Enable the lock screen", "LockScreen", ConfigurationType.Interface, RiskRating.LowRisk, FluentIcons.Common.Icon.LockClosed),
                ["ShortcutText"] = new("Shortcut Text", "ShortcutText", ConfigurationType.Interface, RiskRating.LowRisk, FluentIcons.Common.Icon.WindowNew),
                ["BootLogo"] = new("Boot Logo", "BootLogo", ConfigurationType.BootConfigAppearance, RiskRating.LowRisk, FluentIcons.Common.Icon.Power),
                ["BootMessages"] = new("Boot Messages", "BootMessages", ConfigurationType.BootConfigAppearance, RiskRating.LowRisk, FluentIcons.Common.Icon.Power),
                ["NewBootMenu"] = new("New Boot Menu", "NewBootMenu", ConfigurationType.BootConfigAppearance, RiskRating.LowRisk, FluentIcons.Common.Icon.Options),
                ["SpinningAnimation"] = new("Spinning Animation", "SpinningAnimations", ConfigurationType.BootConfigAppearance, RiskRating.LowRisk, FluentIcons.Common.Icon.SpinnerIos),
                ["AdvancedBootOptions"] = new("Advanced Boot Options on Startup", "AdvancedBootOptions", ConfigurationType.BootConfigBehavior, RiskRating.MediumRisk, FluentIcons.Common.Icon.CalendarSettings),
                ["AutomaticRepair"] = new("Automatic Repair", "AutomaticRepair", ConfigurationType.BootConfigBehavior, RiskRating.MediumRisk, FluentIcons.Common.Icon.WindowDevTools),
                ["KernelParameters"] = new("Kernel Parameters on Startup", "KernelParameters", ConfigurationType.BootConfigBehavior, RiskRating.LowRisk, FluentIcons.Common.Icon.WindowDevEdit),
                ["HighestMode"] = new("Highest Mode", "HighestMode", ConfigurationType.BootConfigBehavior, RiskRating.LowRisk, FluentIcons.Common.Icon.ArrowAutofitUp),
                ["CompactView"] = new("Compact View", "CompactView", ConfigurationType.FileExplorerSubMenu, RiskRating.LowRisk, FluentIcons.Common.Icon.TabDesktopMultipleSparkle),
                ["RemovableDrivesInSidebar"] = new("Removable Drives in Sidebar", "RemovableDrivesInSidebar", ConfigurationType.FileExplorerSubMenu, RiskRating.MediumRisk, FluentIcons.Common.Icon.HardDrive),
                ["BackgroundApps"] = new("Background apps", "BackgroundApps", ConfigurationType.General, RiskRating.MediumRisk, FluentIcons.Common.Icon.AppsSettings),
                ["SearchIndexing"] = new("Search Indexing", "SearchIndexing", ConfigurationType.General, RiskRating.MediumRisk, FluentIcons.Common.Icon.Search),
                ["FsoAndGameBar"] = new("FSO and Game Bar", "FsoAndGameBar", ConfigurationType.General, RiskRating.LowRisk, FluentIcons.Common.Icon.XboxController),
                ["AutomaticUpdates"] = new("Automatic updates", "AutomaticUpdates", ConfigurationType.General, RiskRating.HighRisk, FluentIcons.Common.Icon.WrenchScrewdriver),
                ["DeliveryOptimisation"] = new("Delivery optimisation", "DeliveryOptimisation", ConfigurationType.General, RiskRating.LowRisk, FluentIcons.Common.Icon.CalendarSettings),
                ["Hibernation"] = new("Hibernation", "Hibernation", ConfigurationType.General, RiskRating.LowRisk, FluentIcons.Common.Icon.WeatherMoon),
                ["Location"] = new("Location", "Location", ConfigurationType.General, RiskRating.LowRisk, FluentIcons.Common.Icon.Location),
                ["PhoneLink"] = new("Phone link and mobile devices", "PhoneLink", ConfigurationType.General, RiskRating.LowRisk, FluentIcons.Common.Icon.PhoneDesktop),
                ["PowerSaving"] = new("Power saving", "PowerSaving", ConfigurationType.General, RiskRating.LowRisk, FluentIcons.Common.Icon.BatterySaver),
                ["Sleep"] = new("Sleep", "Sleep", ConfigurationType.General, RiskRating.LowRisk, FluentIcons.Common.Icon.WeatherMoon),
                ["SystemRestore"] = new("System Restore", "SystemRestore", ConfigurationType.General, RiskRating.HighRisk, FluentIcons.Common.Icon.ArrowClockwise),
                ["UpdateNotifications"] = new("Update Notifications", "UpdateNotifications", ConfigurationType.General, RiskRating.LowRisk, FluentIcons.Common.Icon.PhoneUpdate),
                ["WebSearch"] = new("Start Menu Web Search", "WebSearch", ConfigurationType.General, RiskRating.HighRisk, FluentIcons.Common.Icon.GlobeSearch),
                ["Widgets"] = new("Desktop widgets", "Widgets", ConfigurationType.General, RiskRating.LowRisk, FluentIcons.Common.Icon.DesktopEdit),
                ["WindowsSpotlight"] = new("Windows Spotlight", "WindowsSpotlight", ConfigurationType.General, RiskRating.HighRisk, FluentIcons.Common.Icon.Search),
