...
namespace AtlasToolbox.Services.ConfigurationServices
{
    ...
    {
        private const string ATLAS_STORE_KEY_NAME = @"HKLM\SOFTWARE\AtlasOS\RunWithPriority";
        ...
        public RunWithPriorityConfigurationService(
            [FromKeyedServices("RunWithPriorityTest")] ConfigurationStore runWithPriorityConfigurationService)
        {
